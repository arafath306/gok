...
class _CampaignWizardScreenState extends State<CampaignWizardScreen> {
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => ListTile(
                  title: Text(options[index], style: GoogleFonts.hindSiliguri()),
                  trailing: options[index] == currentValue ? const Icon(Icons.check, color: Color(0xFF1E824C)) : null,
                  onTap: () {
  ...
  Widget _buildModernDropdownItem({required String value, required VoidCallback onTap}) {
    return InkWell(
      onTap: onTap,
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text(value, style: GoogleFonts.hindSiliguri(fontSize: 14)),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(icon, size: 18, color: const Color(0xFF1E824C)),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("নতুন ক্যাম্পেইন উইজার্ড", style: GoogleFonts.hindSiliguri()),
      ),
      body: Column(
        children: [
          Expanded(child: SingleChildScrollView(child: _buildStep2Audience())),
          _buildWizardFooter(),
        ],
      ),
    );
                        ...
                        _buildModernDropdownItem(
                          ...
                          onTap: () {
                            _showSelectionBottomSheet(
                              ...
                              currentValue: _selectedDivision,
                              onSelected: (val) {
                                setState(() {
                                  _selectedDivision = val;
                                  _selectedDistrict = _divisionDistricts[val]!.first;
                                });
                              },
                            );
                          },
