        ...
        builder: (context, provider, _) {
          ...
          return Column(
            children: [
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: AppLocalizations.of(context)!.searchUserToMute,
              ...
              // Search results or current muted users list
              Expanded(
                child: _isSearching
                    ? Center(
                        ...
                        ? _searchResults.isEmpty
                            ...
                            : ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  final isMuted = provider.mutedAccounts.any((a) => a['id'] == user['id']);
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        isMuted
                                            ? OutlinedButton(
                                                onPressed: () async {
                                                  await provider.unmuteAccount(user['id']!);
                                                  if (context.mounted) {
                                                ...
                                                child: Text(
                                                  AppLocalizations.of(context)!.unmuteUser,
                                                  style: GoogleFonts.inter(
                                                    color: context.textPrimary,
                                                    fontWeight: FontWeight.bold,
                                                    fontSize: 13,
                                            ...
                                            : ElevatedButton(
                                                onPressed: () async {
                                                  try {
                                                    await provider.muteUserById(user['id']!);
                                                    if (context.mounted) {
                                                      ScaffoldMessenger.of(context).showSnackBar(
                                                        SnackBar(
                            ...
                            : muted.isEmpty
                                ? Center(
                                    child: Column(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        Icon(Icons.volume_off_rounded, size: 60, color: context.textMuted),
                                        const SizedBox(height: 16),
                                        Text(
                                          AppLocalizations.of(context)!.noMutedAccounts,
                                          style: GoogleFonts.inter(
                                            fontSize: 16,
                                            fontWeight: FontWeight.bold,
                                            color: context.textSecondary,
