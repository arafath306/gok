...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get helloWorld => 'హలో వరల్డ్!';

  @override
  String get feed => 'ఫీడ్';

  @override
  String get search => 'శోధన';

  @override
  String get communities => 'సంఘాలు';
  ...
  @override
  String get lowDataMode => 'తక్కువ డేటా మోడ్';

  @override
  String get editProfile => 'ప్రొఫైల్ సవరించండి';

  @override
  String get shareProfile => 'ప్రొఫైల్ భాగస్వామ్యం చేయండి';

  @override
  String get followers => 'ఫాలోవర్లు';

  @override
  String get following => 'ఫాలోయింగ్';

  @override
  String get posts => 'పోస్ట్‌లు';

  @override
  String get replies => 'ప్రత్యుత్తరాలు';

  @override
  String get reposts => 'రీపోస్ట్‌లు';
  ...
  @override
  String get writeAPost => 'ఒక పోస్ట్ వ్రాయండి';

  @override
  String get noRepliesYet => 'ఇంకా ప్రత్యుత్తరాలు లేవు';

  @override
  String get noRepostsYet => 'ఇంకా రీపోస్ట్‌లు లేవు';

  @override
  String get noMediaYet => 'ఇంకా మీడియా లేదు';

  @override
  String get logOut => 'లాగ్ అవుట్';

  @override
  String get block => 'బ్లాక్ చేయండి';

  @override
  String get cancel => 'రద్దు చేయండి';

  @override
  String get report => 'రిపోర్ట్ చేయండి';

  @override
  String get accountBlocked => 'ఖాతా బ్లాక్ చేయబడింది.';

  @override
  String get reportSubmitted => 'రిపోర్ట్ సమర్పించబడింది. ధన్యవాదాలు!';
